...
static GLuint VBO, rotationLocation;
...
static void renderSceneCB()
{
    ...
    glUniformMatrix4fv(rotationLocation, 1, GL_TRUE, &rotation.m[0][0]);
...
static void compileShader(const char* vertex, const char *fragment)
{
    ...
    rotationLocation = glGetUniformLocation(program, "gRotation");
...
int main(int argc, char *argv[])
{
    ...
    int win = glutCreateWindow("Tutorial 07"); // creat window with title
