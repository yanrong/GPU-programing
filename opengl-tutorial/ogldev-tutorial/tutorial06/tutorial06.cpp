...
static GLuint VBO, translateLocation;
...
static void renderSceneCB()
{
    ...
    glUniformMatrix4fv(translateLocation, 1, GL_TRUE, &translation.m[0][0]);
...
static void compileShader(const char* vertex, const char *fragment)
{
    ...
    translateLocation = glGetUniformLocation(program, "gTranslation");
    if (translateLocation == -1) {
...
int main(int argc, char *argv[])
{
    ...
    int win = glutCreateWindow("Tutorial 06"); // creat window with title
