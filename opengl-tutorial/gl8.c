...
void display(void)
{
	...
	glColor4f(0.0f, 1.0f, 0.0f, 1.0f); // set the color to green and full opaque
	glutSolidCube(2.0f);
	...
	glColor4f(1.0f, 0.0f, 0.0f, 0.5f); //Set the color to red and 50% transparent
	glutWireCube(2.0f);
	
	//glutSolidCube(1.5f);
	glutSwapBuffers();	// set double buffer, swap our buffer
...
int main(int argc, char **argv)
{
	...
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGBA);	// Set up a basic display buffer (now set double buffer)  
