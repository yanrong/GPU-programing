...
int main(int argc, char* argv[])
{
    ...
    Shader shader("shaders/advancedLighting.vs", "shaders/advancedLighting.fs");
    ...
    //load texture
    floorTexture = loadTexture(fileSystem::getResource("../resources/textures/wood.png").c_str());
    //shader configure
    shader.use();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //swap buffer and IO poll events
