...
int main(int argc, char* argv[])
{
    ...
    GLuint floorTexture, gammaCorrectedTexture;
    ...
    //load textures
    floorTexture = loadTexture(fileSystem::getResource("../resources/textures/wood.png").c_str(), false);
    gammaCorrectedTexture = loadTexture(fileSystem::getResource("../resources/textures/wood.png").c_str(), true);
