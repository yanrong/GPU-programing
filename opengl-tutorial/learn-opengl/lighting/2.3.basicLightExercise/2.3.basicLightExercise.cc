...
int main(int argc, char *argv[])
{
    ...
    Shader objectShader("shaders/2.3.object.vs", "shaders/2.3.object.fs");
    Shader lightCubeShader("shaders/2.3.lightCube.vs", "shaders/2.3.lightCube.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        objectShader.setVec3("lightPos", lightPostion);
