...
int main(int argc, char *argv[])
{
    ...
    Shader objectShader("shaders/3.2.materials.vs", "shaders/3.2.materials.fs");
    Shader lightCubeShader("shaders/3.2.lightCube.vs", "shaders/3.2.lightCube.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        objectShader.setVec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f); //specular
