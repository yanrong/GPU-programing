...
//for cull face, set each triangles's winding order, clock wise or counter clock wise
...
int main(int argc, char *argv[])
{
    ...
    // build shader
    Shader shader("shaders/cullFace.vs", "shaders/cullFace.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glEnable(GL_CULL_FACE); // only cull face for cube
        glCullFace(GL_FRONT);
        glFrontFace(GL_CCW);
