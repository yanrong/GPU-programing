...
int main(int argc, char *argv[])
{
    ...
    albedo      = loadTexture(fileSystem::getResource("../resources/textures/pbr/rusted_iron/albedo.png").c_str());
    normal      = loadTexture(fileSystem::getResource("../resources/textures/pbr/rusted_iron/normal.png").c_str());
    metallic    = loadTexture(fileSystem::getResource("../resources/textures/pbr/rusted_iron/metallic.png").c_str());
    roughness  = loadTexture(fileSystem::getResource("../resources/textures/pbr/rusted_iron/roughness.png").c_str());
    ao          = loadTexture(fileSystem::getResource("../resources/textures/pbr/rusted_iron/ao.png").c_str());
